...
<details>
   ...
   ```xml
	...
	fill="red" stroke="black" stroke-width="3" />
     ...
     <rect	x="600" y="150" width="400" height="120"
...
<details>
    ...
    Hiermit: pdflatex -jobname=Beispiel.pdf
</details>
...
<details>
    ...
    Die PDF wird als Buch formatiert. Es gibt nun zwei nummerierte Seiten, die erste ist ein Deckblatt und auf der zweiten Seite erscheint "Hello World"
</details>
<details>
